/* src/config/crowdcoin-config.h.  Generated from crowdcoin-config.h.in by configure.  */
/* src/config/crowdcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/crowdcoincoin/crowdcoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Crowdcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Crowdcoin Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "crowdcoincore"
