...
{
    const char* pszTimestamp = "WSJ 13/Nov/2017 Donald Trump Jr. Communicated With WikiLeaks";
    const CScript genesisOutputScript = CScript() << ParseHex("0409ba3c8594444e2e71e725349248aaffa5e688f872efd7accd877199e5b835d1e0054029717649ec5f6936bb4d97c57d954d271a2ee5481e922301cd2e0d40a0") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04894c4f9377760918a10b4b634cb382ef9f9603d0c0a9fedbd2e1630d31c84a2f8e0f9031ab10f9f8ca7c1a7ecb7913d4f2fe140b7edf4d5811a9741b32402bab");
        nDefaultPort = 12845;
...
//        printf("new mainnet genesis hash: %s\n", genesis.GetHash().GetHex().c_str());
        ...
        checkpointData = (CCheckpointData) {
                ...
                1510644922, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams() {
        ...
        vAlertPubKey = ParseHex("0409ba3c8594444e2e71e725349248aaffa5e688f872efd7accd877199e5b835d1e0054029717649ec5f6936bb4d97c57d954d271a2ee5481e922301cd2e0d40a0");
        nDefaultPort = 13845;
