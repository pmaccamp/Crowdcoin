...
Then, to tunnel a SSL connection on 29414 to a RPC server bound on localhost on port 19414 do:

    stunnel -d 29414 -r 127.0.0.1:19414 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:9414/
        ProxyPassReverse http://127.0.0.1:9414/
